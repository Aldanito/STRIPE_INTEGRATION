                ...
                <div className="mx-auto max-w-screen-sm text-center">
                    {status === 'cancel' ? (
                        <>
                            ...
                            <Link href="https://gaiamine.com" className="inline-flex text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:focus:ring-red-900 my-4">Return to Main Page</Link>
                        </>
                    ) : (
                        <>
